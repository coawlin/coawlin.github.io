...
const fadeSideElements = document.querySelectorAll(
  "div[data-animate=fade-side-init]"
);
const fadeBottomElements = document.querySelectorAll(
  "div[data-animate=fade-bottom-init]"
);
